...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val textViewHobbies:TextView? = view?.findViewById(R.id.hobbies)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val adapterLayout = LayoutInflater.from(parent.context)
            .inflate(layoutPressed, parent,false)
...
//        }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.textViewName?.text = context!!.resources.getString(R.string.dog_name)
        holder.textViewAge?.text = context!!.resources.getString(R.string.dog_age)
        holder.textViewHobbies?.text = context!!.resources.getString(R.string.dog_hobbies)
